...
import { selectEditorialStories } from '../lib/editorial'

export function DiscoverPage({ discoveries, signals, selectedId, onOpen, onOpenEarth, onSave, onNotes, onRemove }: { discoveries: Discovery[]; signals: Signal[]; selectedId?: string; onOpen(id: string): void; onOpenEarth(id: string): void; onSave(id: string): void; onNotes(id: string, notes: string): void; onRemove(id: string): void }) {
