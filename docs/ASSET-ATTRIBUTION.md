...
| Global true-color tiles | NASA EOSDIS GIBS MODIS Terra corrected reflectance | Optional delayed 2D context layer |
| Radar tiles | NOAA/NWS MRMS base reflectivity MapServer | Optional live 2D context layer |
| Vector basemap | OpenFreeMap / OpenMapTiles / OpenStreetMap contributors | 2D geographic reference; in-map attribution retained |
